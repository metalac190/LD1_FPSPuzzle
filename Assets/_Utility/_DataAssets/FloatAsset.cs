...
{
    [CreateAssetMenu(menuName = "DataAssets/FloatAsset")]
    public class FloatAsset : ScriptableObject, ISerializationCallbackReceiver
    {
        public float initialValue;      // this is our initial value
        // we want to also keep track of our runtime value, separately
        [System.NonSerialized]
        public float value;      // runtime value that gets changed and edited. Not viewable in Inspector
