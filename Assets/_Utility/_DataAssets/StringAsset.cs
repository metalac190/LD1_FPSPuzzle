...
{
    [CreateAssetMenu(menuName = "DataAssets/StringAsset")]
    public class StringAsset : ScriptableObject, ISerializationCallbackReceiver
    {
        public string initialValue;  //this is our initial value
                                     // we want to also keep track of our runtime value, separately
        [System.NonSerialized]
        public string value;  // runtime value that gets changed and edited. Not viewable in Inspector
